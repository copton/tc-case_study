...
void ec_events(ec_continuation_t cont)
{
    ...
    if (ec_tid() == 1) {
		DEBUGOUT("_6_0: %p", &&_6_0);	
		DEBUGOUT("_6_1: %p", &&_6_1);	
		DEBUGOUT("_7_0: %p", &&_7_0);	
		DEBUGOUT("_7_1: %p", &&_7_1);	
		DEBUGOUT("_7_2: %p", &&_7_2);	
		DEBUGOUT("_7_3: %p", &&_7_3);	
		DEBUGOUT("_7_4: %p", &&_7_4);	
		DEBUGOUT("_7_5: %p", &&_7_5);	
		DEBUGOUT("_8_0: %p", &&_8_0);	
		DEBUGOUT("_8_1: %p", &&_8_1);	
		DEBUGOUT("_9_0: %p", &&_9_0);	
		DEBUGOUT("_9_1: %p", &&_9_1);	
		DEBUGOUT("_9_2: %p", &&_9_2);	
		DEBUGOUT("_9_3: %p", &&_9_3);	
		DEBUGOUT("_9_4: %p", &&_9_4);	
		DEBUGOUT("_10_0: %p", &&_10_0);	
		DEBUGOUT("_10_1: %p", &&_10_1);	
		DEBUGOUT("_11_0: %p", &&_11_0);	
		DEBUGOUT("_11_1: %p", &&_11_1);	
		DEBUGOUT("_12_0: %p", &&_12_0);	
		DEBUGOUT("_12_1: %p", &&_12_1);	
		DEBUGOUT("_12_2: %p", &&_12_2);	
		DEBUGOUT("_12_3: %p", &&_12_3);	
		DEBUGOUT("_13_0: %p", &&_13_0);	
		DEBUGOUT("_13_1: %p", &&_13_1);	
		DEBUGOUT("_13_2: %p", &&_13_2);	
		DEBUGOUT("_13_3: %p", &&_13_3);	
		DEBUGOUT("_13_4: %p", &&_13_4);	
		DEBUGOUT("_13_5: %p", &&_13_5);	
		DEBUGOUT("_13_6: %p", &&_13_6);	
		DEBUGOUT("_14_0: %p", &&_14_0);	
		DEBUGOUT("_14_1: %p", &&_14_1);	
		goto _8_0;
    }
    if (ec_tid() == 2) {
		goto _10_0;
...
_13_2:	S13->now += S13->dt;
		...
		cont.stack = &S13->frames.ec_frame_12;
		goto _12_0;
...
_13_4:	S13->frames.ec_frame_11.handle = S13->send_handle;
		...
		cont.stack = &S13->frames.ec_frame_11;
		goto _11_0;
_13_5:	goto _13_1;
...
_14_0:	s._13.channel = fn_send;
		...
		cont.stack = &S14->frames.ec_frame_13;
		goto _13_0;
_14_1:	assert (false);
		return;
}
